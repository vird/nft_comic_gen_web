...
// System stencils
// PATCH for cyrilic fonts
// ActionManRegular -> CustomRegular -2px
// ActionManBold -> CustomBold
...
stencils.striptitle=[
	{id:"container-title",stencil:{element:"div",css:{fontFamily:"CustomBold",fontSize:"20px",lineHeight:"20px",margin:"5px"}}}
];
stencils.panel=[
...
puppets.persons.narrator={
	...
	position:"outfield",
	stencils:[
		{id:"balloon-text",translatable:true,innerHTML:"phrase",stencil:{element:"div",css:{position:"absolute",left:"0px",top:"0px",fontFamily:"CustomItalic",width:"90px",borderWidth:"0px 1px 1px 0px",borderColor:"#000000",borderStyle:"solid",backgroundColor:"#ffffff",padding:"3px",fontSize:"10px",lineHeight:"11px"}}}
	]
};
